...
static int iwadr_opl_music_register_count = 0;
static int iwadr_opl_music_play_count = 0;
...
static void *I_OPL_RegisterSong(void *data, int len)
{
    ...
    iwadr_opl_music_register_count++;
